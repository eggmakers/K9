...
//							{
								...
								{
									if( vertical_distance[i]*100 > avCfg->wheelbase[0] )
...
static bool CAN_MR72_Av_DriverRun()
{
	...
	CanId Ids[2];
	Ids[0].Identifier = 0x61a;	Ids[0].IdType = 0;
	Ids[1].Identifier = 0x61b;	Ids[1].IdType = 0;
...
void init_drv_CAN_MR72_BackAv()
{
	CanFunc_Register( 67, CAN_MR72_Av_DriverInit, CAN_MR72_Av_DriverRun );
}