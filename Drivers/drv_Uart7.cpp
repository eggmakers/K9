...
void init_drv_Uart7()
{
	...
	DMA2_Stream2->CR = (1 << 20) | (0 << 16) | (0 << 13) | (1 << 10) | (0 << 9) | (0b01 << 6) | (1 << 4);
	...
	UartPort.txSpacesAvailable = Uart7_TxSpacesAvailable;
...
// 获取缓冲区剩余空间
uint16_t Uart7_TxSpacesAvailable()
{
