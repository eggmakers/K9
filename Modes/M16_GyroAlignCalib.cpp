#include "M16_GyroAlignCalib.hpp"
#include "vector3.hpp"
#include "Sensors.hpp"
...
M16_GyroAlignCalib::M16_GyroAlignCalib():Mode_Base( "AccCalib", 12 )
{
...
ModeResult M16_GyroAlignCalib::main_func( void* param1, uint32_t param2 )
{	
