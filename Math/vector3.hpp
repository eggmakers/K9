	...
	public:
		...
		*/
		...
		/*求两单位向量夹角向量
			vec_a , vec_b:单位向量a和b
		*/
			static inline vector3<float> get_included_angle( vector3<float> vec_a , vector3<float> vec_b, float* sinA=0, float* cosA=0  )
			{
				...
				{
					return angle_vec * (atan2f(angle_sin, angle_cosin) / angle_sin);
				}
			}
			static inline vector3<double> get_included_angle( vector3<double> vec_a , vector3<double> vec_b )
			{
				...
				{
					return angle_vec * (atan2(angle_sin, angle_cosin) / angle_sin);
				}
			}
		/*求两单位向量夹角向量*/
};
