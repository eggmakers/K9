...
/*
	...
	false:添加失败（航点过多或航点信息错误或参数表错误）
*/
bool editMission( uint16_t ind, const MissionInf* wp_inf, double TIMEOUT = -1 );
...
*/
bool editCurrentMission( MissionInf* wp_inf, double TIMEOUT = -1 );
