/** @file
 *  @brief MAVLink comm protocol generated from minimalACFly.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_MINIMALACFLY_H
#define MAVLINK_MINIMALACFLY_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_MINIMALACFLY.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#define MAVLINK_ENABLED_MINIMALACFLY
...
typedef enum MAV_COMPONENT
{
   ...
   MAV_COMP_ID_ENGINE_XUANFU_7KW=25, /* Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network. | */
   MAV_COMP_ID_ENGINE_XUANFU_16KW=26, /* Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network. | */
   MAV_COMP_ID_ENGINE_ZONGSHEN=27, /* Id for a component on privately managed MAVLink network. Can be used for any purpose but may not be published by components outside of the private network. | */
   ...
   MAV_COMP_ID_CAMERA_SIYI_ZR10=100, /* Camera #1. | */
   MAV_COMP_ID_CAMERA_INYYO=101, /* Camera #2. | */
   MAV_COMP_ID_CAMERA_RYEOP=102, /* Camera #3. | */
   MAV_COMP_ID_CAMERA_AILF=103, /* Camera #4. | */
   MAV_COMP_ID_CAMERA_VIEWLING=104, /* Camera #5. | */
   MAV_COMP_ID_CAMERA6=105, /* Camera #6. | */
   MAV_COMP_ID_CAMERA_SkyDroid_2_Axis=106, /* Camera #7. | */
   MAV_COMP_ID_CAMERA_SkyDroid_3_Axis=107, /* Camera #8. | */
   MAV_COMP_ID_CAMERA_NEXTVISION=108, /* Camera #9. | */
   MAV_COMP_ID_HYDROGEN_BATTERY=139, /* Camera #9. | */
...
#define IS_COMP_ID_CAMERA(x) (x>=100 && x<=108)
